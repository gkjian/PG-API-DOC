...
class PermissionsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Permission::with(['created_by', 'modified_by'])->select(sprintf('%s.*', (new Permission)->table));
            ...
            $table->rawColumns(['actions', 'placeholder', 'created_by', 'modified_by']);
    ...
    public function store(StorePermissionRequest $request)
    {
        ...
        $request['type'] = Str::beforeLast($request->name, '_');
    ...
    public function show(Permission $permission)
    {
        ...
        $permission->load('created_by', 'modified_by');
