...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.whitelistIpAddress.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.whitelist-ip-addresses.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="gate_id">{{ trans('cruds.whitelistIpAddress.fields.gate') }}</label>
            ...
            <div class="form-group">
                <label class="required">{{ trans('cruds.whitelistIpAddress.fields.status') }}</label>
