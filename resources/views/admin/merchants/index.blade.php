...
@can('merchant_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'Merchant', 'route' => 'admin.merchants.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Merchant">
            <thead>
                <tr>
                    <th width="10">
...
// @endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.merchants.index') }}",
    columns: [
...
// { data: 'person_incharge_name', name: 'person_incharge_name' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Merchant').DataTable(dtOverrideGlobals);
