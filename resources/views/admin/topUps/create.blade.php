...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.topUp.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.top-ups.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('processing_fee') ? 'is-invalid' : '' }}" type="number" name="processing_fee" id="processing_fee" value="{{ old('processing_fee', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('client_transaction') ? 'is-invalid' : '' }}" type="text" name="client_transaction" id="client_transaction" value="{{ old('client_transaction', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('freeze') ? 'is-invalid' : '' }}" type="number" name="freeze" id="freeze" value="{{ old('freeze', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('signature') ? 'is-invalid' : '' }}" type="text" name="signature" id="signature" value="{{ old('signature', '') }}">
